      ...
      <Card title="파이프라인 상태" action={run && (
        ...
        {run && (
          <>
                ...
                return (
                  <li
                    ...
                    className={
                      ...
                      (isErr
                        ? 'border-signal-err bg-soft-err'
                        : phase === 'done'
                        ? 'border-signal-ok bg-soft-ok'
                        : phase === 'active'
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      {phase === 'active' && <span className="h-2 w-2 animate-pulse rounded-full bg-accent" />}
            ...
            {run.error && (
              <div className="mt-3 rounded-md border border-signal-err bg-soft-err px-3 py-2 text-xs text-signal-err">
                에러: {run.error}
              </div>
            )}
      ...
      <Card title="클러스터">
        <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
          {(clustersQ.data || []).map((c) => (
            <div key={c.id} className="rounded-md border border-ink-200 bg-surface p-3">
