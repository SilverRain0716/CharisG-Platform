...
export function GlobalTopBar({
  ...
  // 드랍쉬핑은 2026-08-08 부터 미사용 — 네비에서만 숨긴다.
  // 앱/백엔드(8001)/dropshipping.db 는 그대로 살아 있고 /dropshipping/ 직접 접근도 된다.
  // 다시 쓰려면 아래 줄의 주석만 풀면 복구된다.
  const tabs = [
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-ink-200 bg-surface/80 backdrop-blur supports-[backdrop-filter]:bg-surface/60">
