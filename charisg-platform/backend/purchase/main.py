...
from backend.purchase.routers import (
    summary, dashboard, datalab, searchad, keywords, sourcing, margin,
    customs, competition, pa_products, detail_page, smartstore, coupang,
    orders, tracking, cs, returns, pa_monitor, pa_settings,
)
...
# 19 routers
for r in (summary, dashboard, datalab, searchad, keywords, sourcing, margin,
          customs, competition, pa_products, detail_page, smartstore, coupang,
          orders, tracking, cs, returns, pa_monitor, pa_settings):
